...
model. Built on hydra-zen~\citep{hydrazen2022}, with first-class PyTorch
Lightning~\citep{falcon2019lightning} integration, \texttt{mushin} records each run's configuration

...
reported to the maintainers privately through GitHub's **private vulnerability
reporting** on this repository (Security tab → "Report a vulnerability"), which
delivers the report confidentially to the maintainers. All complaints will be
...
3. **Temporary Ban** — Community Impact: A serious violation of community
   standards. Consequence: A temporary ban from interaction with the community.
